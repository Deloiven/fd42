...
- (UITextField *)nameTextField {
    if (!_nameTextField) {
        ...
        _nameTextField.backgroundColor = [UIColor systemGray3Color];
...
- (UITextField *)xCoordTextField {
    if (!_xCoordTextField) {
        ...
        _xCoordTextField.backgroundColor = [UIColor systemGray3Color];
...
- (UITextField *)yCoordTextField {
    if (!_yCoordTextField) {
        ...
        _yCoordTextField.backgroundColor = [UIColor systemGray3Color];
